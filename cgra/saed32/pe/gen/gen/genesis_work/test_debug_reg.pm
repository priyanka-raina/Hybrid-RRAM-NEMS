...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/akashl/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_debug_reg.svp');
# START USER CODE FROM /home/akashl/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_debug_reg.svp PARSED INTO PACKAGE >>>
# line 1 "/home/akashl/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_debug_reg.svp"
...
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/akashl/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_debug_reg.svp PARSED INTO PACKAGE
