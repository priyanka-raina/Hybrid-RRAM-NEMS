...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/akashl/CGRAGenerator/hardware/generator_z/sb/sb.vp');
# START USER CODE FROM /home/akashl/CGRAGenerator/hardware/generator_z/sb/sb.vp PARSED INTO PACKAGE >>>
# line 1 "/home/akashl/CGRAGenerator/hardware/generator_z/sb/sb.vp"
 use POSIX;
...
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '  output reg [31:0] read_data;';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
 $registered_outputs = "1111111111";
 $feedthrough_outputs = "0000000000";
...
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
 ...
 print SBINFO "Feedthrough: @feedthrough\n";
 print SBINFO "Registered: @registered\n";
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
 ...
 if ($registered_count<1) { $registered_count = 2; }
...
# <<< END USER CODE FROM /home/akashl/CGRAGenerator/hardware/generator_z/sb/sb.vp PARSED INTO PACKAGE
